...
public class ProductoController {
	...
	public Mono<ResponseEntity<Flux<Producto>>> lista() {
		// de forma automatica se guarda en el bodyresponse
	...
	@PostMapping
	// Cuando se trabajaba antes se recibia un dorm data, porque se poblaba un form
	// ahora al ser recibido a traves de un Json que se guarda en el cuerpo del
	// request
	// es de cir un request body
